...
class EngineeringCalculator(Calculator):
    ...
    def square_root(self, x:int, **kwargs: dict[str, any])->any: 
        '''
    ...
    def power(self, x:int, y:int, **kwargs: dict[str, any])->any: 
        '''
    ...
    def log(self, x:int, **kwargs: dict[str, any])->any:  
        '''
    ...
    def ln(self, x:int, **kwargs: dict[str, any])->any: 
        '''
    ...
    def angle_raidans(self, x:int, **kwargs: dict[str, any])->any: 
        '''
    ...
    def sin(self, x:int, **kwargs: dict[str, any])->any: 
        '''
    ...
    def cos(self, x:int, **kwargs: dict[str, any])->any: 
        '''
    ...
    def tan(self, x:int, **kwargs: dict[str, any])->any: 
        '''
